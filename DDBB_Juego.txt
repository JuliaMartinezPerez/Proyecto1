...
SELECT PARTIDAS.GANADOR FROM (JUGADORES, PARTIDAS, PARTICIPACION)
WHERE  PARTIDAS.DURACION > 9
AND    JUGADORES.ID = PARTICIPACION.ID_J
AND    PARTIDAS.ID  = PARTICIPACION.ID_P; 

SELECT PARTIDAS.ID, JUGADORES.USUARIO AS GANADOR
FROM PARTIDAS
JOIN JUGADORES ON PARTIDAS.GANADOR = JUGADORES.USUARIO
WHERE PARTIDAS.DURACION > 9;


/* CONSULTA MARIA */

SELECT PARTIDAS.FECHA_HORA FROM (JUGADORES, PARTIDAS, PARTICIPACION)
WHERE  PARTIDAS.ID = 3
AND    JUGADORES.ID = PARTICIPACION.ID_J
AND    PARTIDAS.ID  = PARTICIPACION.ID_P; 

SELECT PARTIDAS.FECHA_HORA FROM PARTIDAS
WHERE PARTIDAS.ID = 4